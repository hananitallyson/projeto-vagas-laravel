<x-app-layout>
    <main class="flex flex-col">
        <div class="flex justify-between my-1 border-b-2 border-blue-600">
            <h2 class="text-4xl font-bold m-2">Cadastrar Vaga</h2>
        ...
        <form action="{{ route('vagas.store') }}" method="post">
            ...
            <div class="flex flex-col my-2">
                ...
                <input type="text" class="px-2 py-1 border-2 border-gray-300 rounded-lg" name="titulo" value="">
            </div>

            <div class="flex flex-col my-2">
                <label class="font-bold" for="descricao">Descrição</label>
                <textarea class="px-2 py-1 border-2 border-gray-300 rounded-lg" name="descricao"></textarea>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="flex space-x-4 mt-1">
                    ...
                    <div class="flex items-center">
                        <input  id="default-radio-2" type="radio" value="0" name="ativo" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
            ...
            <div class="flex justify-end">
                <button type="submit" class="mt-5 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Cadastrar</button>
            </div>
        </form>
    </main>
</x-app-layout>
